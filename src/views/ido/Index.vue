<template>
  <div style="width: 100%;height: 100%;">
    <!--pc--->
    <div v-show="!isMobile"  style="padding-bottom:20px;width: 100%;min-height: 1500px;background: #161616;padding-top: 85px;">
      <div style="width: 100%;display: flex;">
        <div style="width: 249px;height: 100px;"></div>
        <div style="flex: 1;height: 114px;background: linear-gradient(-45deg, #25434A 0%,  #4A3E48 100%);">
          <div style="max-width:980px ;margin: 0px auto;">
            <div style="font-size: 24px;font-family: Selawik;font-weight: 600;color: #FFFFFF;padding-top: 28px;">IDO: Initial DAO Offerings</div>
            <div style="font-size: 12px;font-family: Selawik;font-weight: 400;color: #FFFFFF;padding-top: 13px;">
              All consensus-builder can buy token fairly.
            </div>
          </div>
        ...
        <div style="flex: 1;z-index: 999;">
          <div style="max-width:980px ;margin: 0px auto;">
            <div style="width: 270px;padding-top: 60px;margin: 0px auto;display: flex;">
              <div @click="clickOgMarket(true)" v-show="isOgMarket"  style=" cursor: pointer;width: 130px;height: 35px;background: linear-gradient(-45deg, #25434A 0%, #4A3E48  100%); border-radius: 10px;text-align: center;line-height: 35px;font-size: 16px;font-family: Selawik;font-weight: 400;color: #FFFFFF;">OG Market</div>
              <div @click="clickOgMarket(true)" v-show="!isOgMarket"  style=" cursor: pointer;width: 130px;height: 35px;background: #242424; border-radius: 10px;text-align: center;line-height: 35px;font-size: 16px;font-family: Selawik;font-weight: 400;color: #FFFFFF;">OG Market</div>

              <div @click="clickOgMarket(false)"  v-show="!isOgMarket"  style=" cursor: pointer; width: 130px;height: 35px;background:  linear-gradient(-45deg, #25434A 0%, #4A3E48  100%); border-radius: 10px;text-align: center;line-height: 35px;margin-left: 20px;font-size: 16px;font-family: Selawik;font-weight: 400;color: #FFFFFF;">Public Market</div>
              <div @click="clickOgMarket(false)"  v-show="isOgMarket" style=" cursor: pointer; width: 130px;height: 35px;background: #242424; border-radius: 10px;text-align: center;line-height: 35px;margin-left: 20px;font-size: 16px;font-family: Selawik;font-weight: 400;color: #FFFFFF;">Public Market</div>
            </div>

            <div style="max-width: 980px;height: 3px;background: #808080;margin:15px auto 0px auto;z-index: -1;"></div>

            <div style="max-width:980px ;margin: 60px auto 0px auto;display: flex;">
              <div style=" max-width: 480px; height: 570px;background: #242424;border-radius: 10px;">
                <div style="padding-top: 40px;padding-left: 50px;font-size: 14px;font-family: Selawik;font-weight: 600;color: #DDDDDD;">Token Information</div>
                <div class="pc-div1">
                  <div class="pc-div1-left" >Contact address</div>
                  <div v-show="isOgMarket" class="pc-div1-right" style="text-decoration: underline;cursor: pointer;" @click="goContract()">{{ this.data.IDO.OG.address.substr(0,10)+"****"+this.data.IDO.OG.address.substr(this.data.IDO.OG.address.length-10,this.data.IDO.OG.address.length)}}</div>
                  <div v-show="!isOgMarket" class="pc-div1-right" style="text-decoration: underline;cursor: pointer;" @click="goContract()">{{ this.data.IDO.NOG.address.substr(0,10)+"****"+this.data.IDO.NOG.address.substr(this.data.IDO.NOG.address.length-10,this.data.IDO.NOG.address.length)}}</div>
                </div>
                ...
                <div class="pc-div1" style="margin-top: 40px;">
                  <div class="pc-div1-left"  style="font-size: 14px;font-family: Selawik;font-weight: 600;color: #DDDDDD;">IDO Information</div>

                </div>

                <div class="pc-div1" >
                  <div class="pc-div1-left" >IDO amount</div>
                  <div v-show="isOgMarket"  class="pc-div1-right" >{{ this.formatAmount(  this.data.IDO.OG.maxAmount1 / this.data.IDO.OG.scala)}}</div>
                  <div v-show="!isOgMarket"  class="pc-div1-right" >{{  this.formatAmount( this.data.IDO.NOG.maxAmount1 / this.data.IDO.NOG.scala)}}</div>
                </div>
                ...
                <div class="pc-div1" >
                  ...
                  <div v-show="isOgMarket"  class="pc-div1-right" >{{ this.formatAmount(  this.data.IDO.OG.minAmount1PerWallet / this.data.IDO.OG.scala)}}</div>
                  <div v-show="!isOgMarket"  class="pc-div1-right" >{{  this.formatAmount( this.data.IDO.NOG.minAmount1PerWallet / this.data.IDO.NOG.scala)}}</div>
                </div>

                <div class="pc-div1" >
                  <div class="pc-div1-left" >Allocation per Whitelist</div>
                  <div v-show="isOgMarket"  class="pc-div1-right" >{{ this.formatAmount(  this.data.IDO.OG.maxAmount1PerWallet / this.data.IDO.OG.scala)}}</div>
                  <div v-show="!isOgMarket"  class="pc-div1-right" >{{  this.formatAmount( this.data.IDO.NOG.maxAmount1PerWallet / this.data.IDO.NOG.scala)}}</div>
                </div>
                ...
                <div class="pc-div1" style="margin-top: 40px;">
                  <div class="pc-div1-left"  style="font-size: 14px;font-family: Selawik;font-weight: 600;color: #DDDDDD;">IDO Progress</div>
                  ...
                  <div v-show="isOgMarket"  class="pc-div1-right" >{{ this.amountTotal12 +'/'+ this.formatAmount(this.data.IDO.OG.maxAmount1 / this.data.IDO.OG.scala) +' '+ this.data.IDO.OG.current  }}</div>
              ...
              <div style=" width: 480px; height: 570px;background: #242424;border-radius: 10px;margin-left: 20px;position: relative;">
                <img :src="pc_ido_img2"  style="width: 120px;height: 120px;position: absolute;top: 0px;left: 0px;"   alt="zh" />
                <div v-show="step==1" style="width: 120px;height: 120px;padding-top: 25px;padding-left: 18px; font-size: 16px;font-family: Selawik;font-weight: 400;color: #242424;transform: rotate(-45deg)">
                  Coming Soon
                </div>
                <div  v-show="step==2"  style="text-align: center;width: 120px;height: 120px;padding-top: 25px;padding-left: 18px; font-size: 16px;font-family: Selawik;font-weight: 400;color: #242424;transform: rotate(-45deg)">
                  Live
                </div>
                <div  v-show="step==3"  style="text-align: center;width: 120px;height: 120px;padding-top: 25px;padding-left: 18px; font-size: 16px;font-family: Selawik;font-weight: 400;color: #242424;transform: rotate(-45deg)">
                  Closed
                </div>
              ...
              <span class="pc_share_div">Only ambassador have the right of invitation
                ...
                the invitee will gain 1% SAT invite reward.</span>
                </div>
                ...
                <div v-show="step==3" style="position: absolute;top: 50px;left: 0px;text-align: center;font-size: 20px;font-family: Selawik; font-weight: 600; color: #EB6877;width:480px;padding-top: 20px; ">
                  {{  'Closed'  }}
                </div>
                ...
                <div  v-show="step!=3"  style="width: 400px;margin:20px auto 0px auto;display: flex;font-size: 14px; font-family: Selawik;font-weight: 400;color: #AAAAAA;position: relative;">
                  Price per token
                  <div v-show="isOgMarket"  style="position: absolute;right: 0px;color: #FFFFFF;">{{ this.calcT12PricePerToken +' '+ this.data.IDO.OG.current }}</div>
                  <div v-show="!isOgMarket"  style="position: absolute;right: 0px;color: #FFFFFF;">{{ this.calcT15PricePerToken +' '+ this.data.IDO.NOG.current }}</div>
                </div>

                <div class="pc-ido-btn3" v-show="step==1" @click="goLink(1)">Join Discord</div>
                <div class="pc-ido-btn3" style="margin-top: 20px;" v-show="step==1&&isOgMarket"  @click="goLink(2)">How to get Whitelist ?</div>

                <div v-show="step==2" style="max-width: 400px;margin:20px auto 0px auto;font-size: 12px; font-family: Selawik;font-weight: 400;color: #FFFFFF;text-align: right;">

                  {{'Balance '+this.currentAddressBalanceOf2_format+' '+ this.data.IDO.OG.current}}
                </div>
                <div v-show="step==2" style="width:  400px;height:  40px;background: #FFFFFF;margin: 15px auto 0px auto;position: relative">
                  <input  v-model="stakeAmount" type="text" style="height:38px;width: 360px;position: absolute;top:1px;left: 5px;"  />
...
<!--              -->
                ...
                <div  v-show="step==1" style="width: 480px;text-align: center;font-size: 14px;font-family: Selawik;font-weight: 400;color: #FFFFFF;padding-top: 20px;">IDO will be live in</div>
                <div  v-show="step==2" style="width: 480px;text-align: center;font-size: 14px;font-family: Selawik;font-weight: 400;color: #FFFFFF;padding-top: 20px;">IDO will be finished in</div>
           ...
           <div style="font-size: 0.32rem;font-family: Selawik; font-weight: 600; color: #FFFFFF;margin-left: 0.3rem;">{{ 'Seconds'}}</div>
            ...
            <div style="float: right;font-size: 0.21rem;font-family: Selawik; font-weight: 400;color: #FFFFFF;" v-show="!isOgMarket">   {{  ' 1 '+ this.data.IDO.NOG.symbol + ' = '  +this.calcT15PricePerToken +' ' +this.data.IDO.NOG.current      }}</div>
                ...
                <div  v-show="step==3"  style="width: 400px;margin:20px auto 0px auto;display: flex;font-size: 14px; font-family: Selawik;font-weight: 400;color: #AAAAAA;position: relative;">
                  ...
                  <div v-show="!isOgMarket"  style="position: absolute;right: 0px;color: #FFFFFF;">{{  ' 1 '+ this.data.IDO.NOG.symbol + ' = '  +this.calcT15PricePerToken +' ' +this.data.IDO.NOG.current  }}</div>
                </div>

                <div  v-show="step==3"  style="width: 400px;margin:20px auto 0px auto;display: flex;font-size: 14px; font-family: Selawik;font-weight: 400;color: #AAAAAA;position: relative;">
                  Total IDO amount
                  <div v-show="isOgMarket"  style="position: absolute;right: 0px;color: #FFFFFF;">{{  this.formatAmount(  this.data.IDO.OG.maxAmount1 / this.data.IDO.OG.scala) + this.data.IDO.OG.current   }}</div>
                  <div v-show="!isOgMarket"  style="position: absolute;right: 0px;color: #FFFFFF;">{{  this.formatAmount( this.data.IDO.NOG.maxAmount1 / this.data.IDO.NOG.scala) + this.data.IDO.NOG.current  }}</div>
                </div>
                <div  v-show="step==3"  style="width: 400px;margin:20px auto 0px auto;display: flex;font-size: 14px; font-family: Selawik;font-weight: 400;color: #AAAAAA;position: relative;">
                  Successful IDO amount
                  <div v-show="isOgMarket"  style="position: absolute;right: 0px;color: #FFFFFF;">{{  this.amountTotal12_format + this.data.IDO.OG.current   }}</div>
                  <div v-show="!isOgMarket"  style="position: absolute;right: 0px;color: #FFFFFF;">{{ this.amountTotal15_format + this.data.IDO.NOG.current   }}</div>
                </div>
        ...
        <img :src="pc_ido_img1"  style="width: 1135px;height: 294px;position: fixed;bottom:0px ;left: 110px;"   alt="zh" />
      </div>
    ...
    <!--h5--->
    <div v-show="isMobile" style="width: 10rem;background: #070707;min-height: 20rem; padding-bottom: 3rem;padding-top: 2.11rem;">
  ...
  -->
      <div style="padding-left: 0.84rem;margin-top:0.81rem;display: flex ">
        ...
        <div   @click="clickOgMarket(false)"   :class="!isOgMarket ?'h5-ido-btn1':'h5-ido-btn2'" style="margin-left: 0.27rem;">
          Public Market
        </div>
      ...
      <div style="width: 8.27rem;padding-bottom: 0.63rem;background: #242424;border-radius: 0.13rem;margin:0.55rem auto 0rem auto;position: relative; "   v-show="step==1" >
        ...
        <div style="font-size: 0.21rem;font-family: Selawik;font-weight: 600; color: #FFFFFF;width: 8.27rem;text-align: center;padding-top: 0.59rem;">Fundraise Goal</div>

        <div style="font-size: 0.27rem;font-family: Selawik; font-weight: 600;color: #FFFFFF;width: 8.27rem;text-align: center;padding-top: 0.19rem;" v-show="isOgMarket&&step!=3">{{  this.formatAmount(  this.data.IDO.OG.maxAmount1 / this.data.IDO.OG.scala) + ' '+this.data.IDO.OG.current   }}</div>
        <div style="font-size: 0.27rem;font-family: Selawik; font-weight: 600;color: #FFFFFF;width: 8.27rem;text-align: center;padding-top: 0.19rem;" v-show="!isOgMarket&&step!=3">{{   this.formatAmount( this.data.IDO.NOG.maxAmount1 / this.data.IDO.NOG.scala)+ ' '+this.data.IDO.NOG.current   }}</div>
        ...
        <div style="width: 6.8rem;margin: 0.27rem auto 0rem auto; font-size: 0.21rem;font-family: Selawik;font-weight: 400; color: #808080;">
          Price per token
          <div v-show="isOgMarket"  style="float: right;font-size: 0.21rem;font-family: Selawik; font-weight: 400;color: #FFFFFF;">{{ this.calcT12PricePerToken + this.data.IDO.OG.current }}</div>
          <div v-show="!isOgMarket"  style="float: right;font-size: 0.21rem;font-family: Selawik; font-weight: 400;color: #FFFFFF;">{{ this.calcT15PricePerToken + this.data.IDO.NOG.current }}</div>
        </div>
        <div class="h5-ido-btn3"  @click="goLink(1)">
          Join Discord
        </div>
        <div class="h5-ido-btn3"  @click="goLink(2)"  v-show="isOgMarket" >
          How to get Whitelist ?
        </div>


        <div style="height: 0.03rem; background: #5F5F5F;width: 6.8rem;text-align: center;margin: 0.4rem auto 0rem auto;"></div>

        <div style="font-size: 0.19rem;font-family: Selawik; font-weight: 400;color: #FFFFFF;width: 8.27rem;text-align: center;padding-top: 0.32rem;">IDO will be live in</div>

        <div style="width: 3.7rem;margin: 0.5rem auto 0 auto;display: flex;">
          <div style="font-size: 0.32rem;font-family: Selawik; font-weight: 600; color: #FFFFFF;">{{ this.mDay >=10 ? this.mDay:'0'+this.mDay}}</div>
          <div style="margin-left: 0.3rem;padding-top: 0.11rem;">
            <div style="width: 0.1rem; height: 0.1rem;background: linear-gradient(-45deg, #FED6E3 0%, #A8EDEA 100%); border-radius: 50%;"></div>

            <div style="width: 0.1rem; height: 0.1rem;background: linear-gradient(-45deg, #A8EDEA 0%, #FED6E3 100%); border-radius: 50%;margin-top: 0.05rem;"></div>
          </div>
          <div style="font-size: 0.32rem;font-family: Selawik; font-weight: 600; color: #FFFFFF;margin-left: 0.3rem;">{{ this.mH0+''+this.mH1}}</div>
          <div style="margin-left: 0.3rem;padding-top: 0.11rem;">
            <div style="width: 0.1rem; height: 0.1rem;background: linear-gradient(-45deg, #FED6E3 0%, #A8EDEA 100%); border-radius: 50%;"></div>

            <div style="width: 0.1rem; height: 0.1rem;background: linear-gradient(-45deg, #A8EDEA 0%, #FED6E3 100%); border-radius: 50%;margin-top: 0.05rem;"></div>
          </div>
          <div style="font-size: 0.32rem;font-family: Selawik; font-weight: 600; color: #FFFFFF;margin-left: 0.3rem;">{{ this.mM0+''+this.mM1}}</div>
          <div style="margin-left: 0.3rem;padding-top: 0.11rem;">
            <div style="width: 0.1rem; height: 0.1rem;background: linear-gradient(-45deg, #FED6E3 0%, #A8EDEA 100%); border-radius: 50%;"></div>
      ...
      <!---close-->
      <div style="width: 8.27rem;padding-bottom: 2.63rem;background: #242424;border-radius: 0.13rem;margin:0.55rem auto 0rem auto; "  v-show="step==3">
        <div style="font-size: 0.21rem;font-family: Selawik;font-weight: 600; color: #FFFFFF;width: 8.27rem;text-align: center;padding-top: 0.59rem;">Fundraise Goal</div>

        <div style="font-size: 0.27rem;font-family: Selawik; font-weight: 600;color: #EB6877;width: 8.27rem;text-align: center;padding-top: 0.19rem;">Closed</div>
        ...
        <div style="width: 6.8rem;margin: 0.27rem auto 0rem auto; font-size: 0.21rem;font-family: Selawik;font-weight: 400; color: #808080;">
          Total IDO amount
          <div v-show="isOgMarket" style="float: right;font-size: 0.21rem;font-family: Selawik; font-weight: 400;color: #FFFFFF;">{{  this.formatAmount(  this.data.IDO.OG.maxAmount1 / this.data.IDO.OG.scala) + this.data.IDO.OG.current  }}</div>
          <div v-show="!isOgMarket" style="float: right;font-size: 0.21rem;font-family: Selawik; font-weight: 400;color: #FFFFFF;">{{ this.formatAmount( this.data.IDO.NOG.maxAmount1 / this.data.IDO.NOG.scala) + this.data.IDO.NOG.current  }}</div>
        </div>

        <div style="width: 6.8rem;margin: 0.27rem auto 0rem auto; font-size: 0.21rem;font-family: Selawik;font-weight: 400; color: #808080;">
          Successful IDO amount
          <div v-show="isOgMarket" style="float: right;font-size: 0.21rem;font-family: Selawik; font-weight: 400;color: #FFFFFF;">{{  this.amountTotal12_format + this.data.IDO.OG.current  }}</div>
          <div v-show="!isOgMarket" style="float: right;font-size: 0.21rem;font-family: Selawik; font-weight: 400;color: #FFFFFF;">{{  this.amountTotal15_format + this.data.IDO.NOG.current  }}</div>
        </div>
      ...
      <div style="width: 8.27rem;padding-bottom: 0.63rem;background: #242424;border-radius: 0.13rem;margin:0.55rem auto 0rem auto;position: relative; "  v-show="step==2">
        ...
        <div v-show="isOgMarket"   style="width: 6.8rem;margin: 0.3rem auto 0rem auto; font-size: 0.16rem;font-family: Selawik;font-weight: 400;color: #FFFFFF;text-align: right">
          {{'Balance '+this.currentAddressBalanceOf2_format+' '+ this.data.IDO.OG.current}}
        </div>
        <div v-show="!isOgMarket"   style="width: 6.8rem;margin: 0.3rem auto 0rem auto; font-size: 0.16rem;font-family: Selawik;font-weight: 400;color: #FFFFFF;text-align: right">
          {{'Balance '+this.currentAddressBalanceOf5_format+' '+ this.data.IDO.NOG.current}}
        </div>
        ...
        <div style="font-size: 0.19rem;font-family: Selawik; font-weight: 400;color: #FFFFFF;width: 8.27rem;text-align: center;padding-top: 0.32rem;">IDO will be finished in</div>

        <div style="width: 3.7rem;margin: 0.5rem auto 0 auto;display: flex;">
          <div style="font-size: 0.32rem;font-family: Selawik; font-weight: 600; color: #FFFFFF;">{{  this.mDay >=10 ? this.mDay:'0'+this.mDay}}</div>
          <div style="margin-left: 0.3rem;padding-top: 0.11rem;">
            <div style="width: 0.1rem; height: 0.1rem;background: linear-gradient(-45deg, #25434A 0%, #4A3E48  100%); border-radius: 50%;"></div>

            <div style="width: 0.1rem; height: 0.1rem;background: linear-gradient(-45deg, #25434A 0%, #4A3E48  100%); border-radius: 50%;margin-top: 0.05rem;"></div>
          </div>
          <div style="font-size: 0.32rem;font-family: Selawik; font-weight: 600; color: #FFFFFF;margin-left: 0.3rem;">{{ this.mH0+''+this.mH1}}</div>
          <div style="margin-left: 0.3rem;padding-top: 0.11rem;">
            <div style="width: 0.1rem; height: 0.1rem;background: linear-gradient(-45deg, #25434A 0%, #4A3E48  100%); border-radius: 50%;"></div>
      ...
      <!--end 0-->
      <!-----1--->
      <div style="width: 8.27rem;padding-bottom: 0.63rem;background: #242424;border-radius: 0.13rem;margin:0.4rem auto 0rem auto; ">
        <div style="font-size: 0.19rem; font-family: Selawik;font-weight: 600; color: #FFFFFF;padding-top: 0.57rem;padding-left: 0.73rem;position: relative;display: flex;">
          IDO Progress
          <div v-show="isOgMarket"  style="position: absolute;right: 0.5rem;">{{ this.amountTotal12 +'/'+ this.formatAmount(this.data.IDO.OG.maxAmount1 / this.data.IDO.OG.scala) + ' '+this.data.IDO.OG.current  }} </div>
          <div v-show="!isOgMarket"  style="position: absolute;right: 0.5rem;">{{ this.amountTotal15 +'/'+ this.formatAmount(this.data.IDO.NOG.maxAmount1 / this.data.IDO.NOG.scala) + ' '+this.data.IDO.OG.current  }}</div>
        </div>
        ...
        <div style="font-size: 0.19rem; font-family: Selawik;font-weight: 600; color: #FFFFFF;padding-top: 0.8rem;padding-left: 0.73rem;">Token Information</div>

        <div style="font-size: 0.19rem; font-family: Selawik;font-weight: 600; color: #808080;margin-top: 0.34rem;padding-left: 0.73rem;">
          Contact address
          <div v-show="isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem;text-decoration: underline;cursor: pointer;"   @click="goContract()" >{{ this.data.IDO.OG.address.substr(0,10)+"****"+this.data.IDO.OG.address.substr(this.data.IDO.OG.address.length-10,this.data.IDO.OG.address.length)}}</div>
          <div v-show="!isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem;text-decoration: underline;cursor: pointer;"   @click="goContract()" >{{ this.data.IDO.NOG.address.substr(0,10)+"****"+this.data.IDO.NOG.address.substr(this.data.IDO.NOG.address.length-10,this.data.IDO.NOG.address.length)}}</div>
        </div>
        <div style="font-size: 0.19rem; font-family: Selawik;font-weight: 600; color: #808080;margin-top: 0.34rem;padding-left: 0.73rem;">
          Token symbol
          <div v-show="isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem">{{ this.data.IDO.OG.symbol}}</div>
          <div v-show="!isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem">{{ this.data.IDO.NOG.symbol}}</div>
        </div>
        <div style="font-size: 0.19rem; font-family: Selawik;font-weight: 600; color: #FFFFFF;margin-top: 0.56rem;padding-left: 0.73rem;">
          IDO Information
        </div>
        <div style="font-size: 0.19rem; font-family: Selawik;font-weight: 600; color: #808080;margin-top: 0.34rem;padding-left: 0.73rem;">
          IDO amount
          <div v-show="isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem">{{ this.formatAmount( this.data.IDO.OG.maxAmount1 / this.data.IDO.OG.scala ) }}</div>
          <div v-show="!isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem">{{ this.formatAmount( this.data.IDO.NOG.maxAmount1 / this.data.IDO.NOG.scala ) }}</div>
        </div>

        <div style="font-size: 0.19rem; font-family: Selawik;font-weight: 600; color: #808080;margin-top: 0.34rem;padding-left: 0.73rem;">
          IDO currency
          <div style="color: #FFFFFF;margin-top: 0.2rem" v-show="isOgMarket">{{ this.data.IDO.OG.current}}</div>
          <div style="color: #FFFFFF;margin-top: 0.2rem" v-show="!isOgMarket">{{ this.data.IDO.NOG.current}}</div>
        </div>
        <div style="font-size: 0.19rem; font-family: Selawik;font-weight: 600; color: #808080;margin-top: 0.34rem;padding-left: 0.73rem;">
          Price per unit, $
          <div v-show="isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem">{{ this.calcT12PricePerToken }}</div>
          <div v-show="!isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem">{{ this.calcT15PricePerToken }}</div>
        </div>
        <div style="font-size: 0.19rem; font-family: Selawik;font-weight: 600; color: #808080;margin-top: 0.34rem;padding-left: 0.73rem;">
          Minimum amount
          <div v-show="isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem">{{  this.formatAmount( this.data.IDO.OG.minAmount1PerWallet/ this.data.IDO.OG.scala  ) }}</div>
          <div v-show="!isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem">{{  this.formatAmount( this.data.IDO.NOG.minAmount1PerWallet  / this.data.IDO.NOG.scala ) }}</div>
        </div>
        <div style="font-size: 0.19rem; font-family: Selawik;font-weight: 600; color: #808080;margin-top: 0.34rem;padding-left: 0.73rem;">
          Allocation per Whitelist
          <div v-show="isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem">{{  this.formatAmount( this.data.IDO.OG.maxAmount1PerWallet/ this.data.IDO.OG.scala  ) }}</div>
          <div v-show="!isOgMarket"  style="color: #FFFFFF;margin-top: 0.2rem">{{  this.formatAmount( this.data.IDO.NOG.maxAmount1PerWallet  / this.data.IDO.NOG.scala ) }}</div>
        </div>
    ...
    >
      ...
      <div  v-show="!isMobile">
        ...
        <div style="padding-top: 20px;position: relative;">
          <img :src="close" style="width: 17px;height: 17px;left: 45px;top: 20px;position: absolute;z-index: 999;" @click="showInviteDialog = false" />
          <div style="position: absolute;text-align: center;left: 0px;top: 20px;font-size: 18px;font-family: Selawik; font-weight: 600;color: #FFFFFF;width: 700px;">
            Invite
          </div>

          <div style="width: 600px; height: 50px; background: #FFFFFF;border-radius: 10px;margin: 80px auto 0px auto;
                line-height: 50px;padding-left: 20px;font-size: 16px;font-family: Selawik;font-weight: 300;color: #000000;">
            {{this.shareLinkUrl.length >55 ? this.shareLinkUrl.substr(0,35)+'****'+ this.shareLinkUrl.substr(this.shareLinkUrl.length -20,this.shareLinkUrl.length):this.shareLinkUrl}}
          </div>

          <div class="bbbttt"   v-clipboard:copy="this.shareLinkUrl"
               v-clipboard:success="onCopy"
               v-clipboard:error="onError">Copy</div>


          <div style="width: 580px; margin: 30px auto 0px auto;
             font-size:12px;font-family: Selawik;font-weight: 300;color: #FFFFFF;">
            *Only ambassador have the right of invitation.
          </div>
          <div style="width: 580px; margin: 10px auto 0px auto;padding-bottom: 40px;
             font-size:12px;font-family: Selawik;font-weight: 300;color: #FFFFFF;">
            Ambassador can gain SAT invite reward of 4%, the invitee will gain 1% SAT invite reward.
          </div>
      ...
      <div  v-show="isMobile">
        <div style="width: 8.27rem;position: relative; ">
          <img :src="close" style="width: 0.3rem;height: 0.3rem;left: 0.36rem;top: 0.36rem;position: absolute;z-index: 999;" @click="showInviteDialog=false" />
        </div>
        <div style="width: 8.27rem;position: relative;font-size: 0.21rem;font-family: Selawik;font-weight: 600;color: #FFFFFF;padding-top: 0.3rem;text-align: center;">Invite </div>


        <div style="width: 6.8rem; height:0.67rem; background: #FFFFFF;border-radius: 0.13rem;margin: 0.6rem auto 0rem auto;
                line-height: 0.67rem;padding-left:0.1rem;font-size: 0.19rem;font-family: Selawik;font-weight: 300;color: #000000;">
          {{this.shareLinkUrl.length >35 ? this.shareLinkUrl.substr(0,20)+'****'+ this.shareLinkUrl.substr(this.shareLinkUrl.length -15,this.shareLinkUrl.length):this.shareLinkUrl}}
        </div>


        <div class="h5bbbttt"   v-clipboard:copy="this.shareLinkUrl"
             v-clipboard:success="onCopy"
             v-clipboard:error="onError">Copy</div>
...
export default {
  ...
  */
  ...
  methods: {
    ...
    goContract(){
      if(this.isOgMarket){
        window.open('https://polygonscan.com/address/'+this.data.IDO.OG.contractAddress);
      }else{
        window.open('https://polygonscan.com/address/'+this.data.IDO.NOG.contractAddress);
      }
    },
    format(shijianchuo)
    {
    ...
    getInfo(){
      ...
      watcher.subscribe(update => {
        ...
        if(update.type=='amountSwapped12'){
          ...
          this.currentAddressBalanceOf2_format = this.formatAmount(this.currentAddressBalanceOf2);
    ...
    formatTime1(difTime){
      ...
      return day+'days'+h0Time +''+ h1Time+"hours"+m0Time+''+m1Time+"mins"+s0Time+''+s1Time+"secs";
    },
    formatAmount (val){
...
.h5_share_img{
  cursor: pointer;
  width: 0.27rem;height: 0.27rem;position: absolute;right: 0.5rem;top: 0.5rem
}
.h5_share_div{

  display:none;
  border-radius: 0.13rem; background: #333333;width: 3.07rem;padding: 0.2rem;position: absolute;right: 0.5rem;top: 0.6rem;font-size: 14px;z-index: 999
}
.h5_share_img:hover span{
  font-size: 0.13rem;font-family: Selawik; font-weight: 400; color: #CCCCCC;
  display: inline-block;
}
.bbbttt{
  width: 600px; height: 50px; background: #0792E3;border-radius: 10px;margin: 25px auto 0px auto;cursor: pointer;
  font-size: 20px;font-family: Selawik;font-weight: 600;color: #FFFFFF; text-align: center;line-height: 50px;
}
.bbbttt:hover{
  background: #59AEE0FF;
}
.h5bbbttt{
  width:  6.8rem; height:  0.67rem; background: #0792E3;border-radius: 0.13rem;margin: 0.3rem auto 0rem auto;cursor: pointer;
  font-size: 0.24rem;font-family: Selawik;font-weight: 600;color: #FFFFFF; text-align: center;line-height: 0.67rem;
}
.h5bbbttt:hover{
  background: #59AEE0FF;
}
.pc_share_img{
  width: 20px;height: 20px;position:absolute;right: 35px;top: 35px;
...
.pc_share_div{
  ...
  background: #333333;border-radius: 10px;padding: 5px; position:absolute;right: 0px;top: 20px;width: 208px;font-size: 10px;font-family: Selawik; font-weight: 400;
...
.h5-progress{
  height: 0.21rem;left: 0rem;top: 0rem; background: linear-gradient(-45deg, #25434A 0%, #4A3E48  100%);border-radius: 0.13rem;position: absolute;
}

.pc-progress{
  height: 16px;left: 0px;top: 0px; background: linear-gradient(-45deg, #4A3E48 0%, #25434A 100%);border-radius: 8px;position: absolute;
}



.pc-div1{
  width: 480px;display: flex;position: relative;font-size: 14px;font-family: Selawik;font-weight: 400;color: #FFFFFF;margin-top: 18px;
  .pc-div1-left{
    padding-left: 50px;color: #DDDDDD;
  }
  .pc-div1-right{
...
.pc-ido-btn3{
  width: 400px;  height: 50px; background: rgba(65,67,70,0.5);border-radius: 10px;font-size: 16px;line-height: 50px;
  font-family: Selawik;font-weight: 600;color: #FFFFFF;text-align: center;margin: 30px auto 0px auto;cursor: pointer;
}
...
.pc-ido-btn3x{
  width: 400px;  height: 50px; background: #414346;border-radius: 10px;font-size: 16px;line-height: 50px;
  font-family: Selawik;font-weight: 600;color: #FFFFFF;text-align: center;margin: 30px auto 0px auto;
}

.pc-ido-time{
  font-size: 24px;font-family: Selawik;font-weight: 600;color: #FFFFFF;
}


.pc-ido-time1{
  font-size: 12px;font-family: Selawik;color: #FFFFFF;
}


.h5-ido-btn1{
  font-size: 0.21rem; font-family: Selawik;font-weight: 400;color: #FFFFFF;cursor: pointer;
  width: 2.8rem;height: 0.55rem; background: linear-gradient(-45deg, #4A3E48 0%, #25434A 100%);border-radius: 0.13rem; text-align: center;line-height: 0.55rem;
}
.h5-ido-btn1:hover{
...
.h5-ido-btn2{
  font-size: 0.21rem; font-family: Selawik;font-weight: 400;color: #FFFFFF;cursor: pointer;
  width: 2.8rem;height: 0.55rem; background: #242424;border-radius: 0.13rem; text-align: center;line-height: 0.55rem;
}
...
.h5-ido-btn3{
  width: 6.8rem; height: 0.67rem; background: rgba(65,67,70,0.5);border-radius: 0.13rem;font-size: 0.21rem;line-height: 0.67rem;
  font-family: Selawik;font-weight: 600;color: #FFFFFF;text-align: center;margin: 0.3rem auto 0rem auto;cursor: pointer;
}
...
.h5-ido-btn3x{
  width: 6.8rem; height: 0.67rem;background: #414346;border-radius: 0.13rem;font-size: 0.21rem;line-height: 0.67rem;
  font-family: Selawik;font-weight: 600;color: #FFFFFF;text-align: center;margin: 0.3rem auto 0rem auto;
}
...
.add_vvs_coin{
  width: 60px; height: 30px;font-size: 20px;font-family: Lato;font-weight: 600;color: #101529;background-color: rgba(255,255,255, 0.3);line-height: 0.6;border-radius:3px 3px;
  padding-left: 5px;
  position: absolute;
  right: 20px;
  top: 25px;
...
.add_vvs_coin1{
  margin-top: 0.2rem;
  margin-left: 0.3rem;width: 1.2rem; height: 0.6rem;font-size: 0.32rem;font-family: Lato;font-weight: 600;color: #101529;background-color: rgba(249,79,1, 0.3);line-height:0.6rem;border-radius:0.13rem 0.13rem;
  padding-left: 0.2rem;
  //position: absolute;
  //right: 20px;
  //top: 3rem;
...
.btn{
  cursor: pointer;margin: 13px auto 0px auto;width: 750px;line-height: 56px;height: 56px;background: #2C3852; border-radius: 5px;font-size: 18px;font-family: Lato;font-weight: bold;color: #FFFFFF;text-align: center;
}
.btnx{
  margin: 13px auto 0px auto;width: 750px;line-height: 56px;height: 56px;background:  #a6a6a6; border-radius: 5px;font-size: 18px;font-family: Lato;font-weight: bold;color: #FFFFFF;text-align: center;
}
.btn:hover{
  background: #a6a6a6;
}
.btn1{
  cursor: pointer;
  margin: 0.2rem auto 0px auto; width: 8.53rem;
  line-height: 56px;height: 0.75rem;
  background: #2C3852; border-radius: 0.07rem;
  font-size: 0.24rem;font-family: Lato;font-weight: bold;
...
.btn1x{
  ...
  margin: 0.2rem auto 0px auto; width: 8.53rem;
  line-height: 56px;height: 0.75rem;
  background: #a6a6a6; border-radius: 0.07rem;
  font-size: 0.24rem;font-family: Lato;font-weight: bold;
  color: #FFFFFF;text-align: center;
}
.btn1:hover{
